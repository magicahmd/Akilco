...
export default class WaiterOnTableOrders extends Component {
    ...
    constructor(props) {
      ...
      getdata() {
        url = URL.getWaiterOnTableOrders(this.state.user_id, this.state.id);
        return fetch(url)
      ...
      componentWillMount() {
        DeviceEventEmitter.addListener('refreshWaiterOnTableOrders', (e)=>{this.getdata()});
          this.getdata();
            }
      ...
      renderDishes() {
        ...
        return Orders.map((item) => {
            ...
            return (
                ...
                <ListItem style={styles.listItemContainer} onPress={() => this.props.navigation.navigate("OrderInfo",{id:item.id,status:'on Table'})}>
